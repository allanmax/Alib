package com.common.lib.barscan;
...
import com.common.lib.barscan.camera.CameraManager;
import com.common.lib.barscan.decode.CaptureActivityHandler;
import com.common.lib.barscan.view.ViewfinderView;
 ...
 * 3.扫描成功后会将扫描结果返回上一界面。
 *
 * @author dswitkin@google.com Allan modify
 * @author Sean Owen
 */
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lib_bar_capture);
